...
public class ServiceListagem {
    ...
    public static void cadastrarListagem(String Produtos, Double valorTotal, String Cliente, 
            Integer qtdItems, String dataVenda) throws ProdutoException, DataSourceException {
        try {
